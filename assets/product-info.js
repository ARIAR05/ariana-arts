  ...
  customElements.define(
    ...
    class ProductInfo extends HTMLElement {
      ...
      InitImages() {
        ...
        const variantImgs = this.querySelectorAll(".product__media-item ");
        let checkedInput = this.querySelector(
          ".product-form__input input:checked"
        );
        checkedInput = checkedInput?.value.replaceAll(" ", "-");
        console.log(checkedInput);
        variantImgs.forEach((img) => {
          if (
            img.classList.contains(checkedInput) ||
            img.classList.contains("all_variants")
          ) {
      ...
      initQuantityHandlers() {
        ...
        // this.InitImages(); //mostrar la primera img del producto
      ...
      handleUpdateProductInfo(productUrl) {
        return (html) => {
          ...
          // this.updateImageVariant(variant?.id);
          if (!variant) {
            this.setUnavailable();
            return;
          }
      ...
      // updateImageVariant(variantId) {
      //   const images = this.querySelectorAll(".product__media-item");
      //   images.forEach((image) => {
      //     if (image.classList.contains(variantId)) {
